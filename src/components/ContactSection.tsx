        ...
        <div className="contact__layout">
          ...
          <div>
            ...
            <h2 className="section-title">
              Adoraríamos{" "}
              <span className="gradient-text-emerald">Ouvir Você</span>
            </h2>
            <p className="section-subtitle">
              Entre em contato conosco e tire suas dúvidas. Plantão emergencial
              24 horas todos os dias da semana, incluindo domingos e feriados.
            </p>
            ...
            <div className="contact__info-list">
              ...
              <div className="contact__info-item">
                ...
                <div>
                  ...
                  <span className="contact__info-value">
                    Rua Maringá, 278 - Embu das Artes - SP
                  </span>
                  <span className="contact__info-sub">
          ...
          <div>
            <div className="contact__form-card">
              <div className="contact__form-header">
                ...
                <div>
                  ...
                  <p className="contact__form-subtitle">
                    Preencha e receba atendimento imediato pelo WhatsApp do
                    nosso técnico
                  </p>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  >
                    ...
                    <option value="Desentupimento Profissional">
                      Desentupimento Profissional
                    </option>
                    <option value="Controle de Cupins (Descupinização)">
                      Controle de Cupins (Descupinização)
                    </option>
                    <option value="Controle de Percevejos">
                      Controle de Percevejos
                    </option>
                    <option value="Controle de Mosquitos e Pernilongos">
                      Controle de Mosquitos e Pernilongos
                    </option>
                    <option value="Controle de Roedores (Desratização)">
                      Controle de Roedores (Desratização)
                    </option>
                    <option value="Manejo de Pombos">Manejo de Pombos</option>
                    <option value="Inspeção Preventiva">
                      Inspeção Preventiva / Outros
                    </option>
                  </select>
                </div>
              ...
              >
                ...
                />
                <span>
                  Seus dados são utilizados exclusivamente para agendar a visita
                  técnica.
                </span>
              </div>
            </div>
